...
Map<Boolean,List<Integer>> partitioned =numbers
		...
		System.out.println("Even numbers are : "+ partitioned.get(true));
		System.out.println("Odd numbers are : "+ partitioned.get(false));
	}

}
/*
 Returns a Collector which partitions the input elements accordingto a Predicate, 
 ...
 There are no guarantees on the type, mutability, serializability, or
  thread-safety of the Map or Listreturned
 */
